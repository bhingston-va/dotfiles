...
description: Generates or suggests git commit messages following the user's Conventional Commits preferences (feat, fix, chore, refactor, prefactor, doc) and optional scopes. Use when writing commit messages, amending commits, or when the user asks for commit message help or mentions conventional commits.
---
